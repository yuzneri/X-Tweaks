...
export const ja: Messages = {
  ...
  tabs: {
    ...
    effective: '適用中の設定',
    /**
     * サイトのページの4つ目。タイムラインに出る、ポストではないものが入る（x.com は先頭の投稿
     * ボックスと新着、両サイトは X が差し込むもの）。3つ目の「外枠」と対になる
     */
    inTimeline: 'タイムラインの中',
  },
  ...
  search: {
    ...
    fields: {
      ...
      from: 'アカウントの投稿を含む',
      fromExclude: 'アカウントの投稿を除く',
      to: 'アカウントへの返信を含む',
      toExclude: 'アカウントへの返信を除く',
      mentioning: 'アカウントへの言及を含む',
      mentioningExclude: 'アカウントへの言及を除く',
      list: 'リストのメンバー（ユーザー/リスト名）',
      ...
      images: '画像',
      videos: '動画',
      choices: { any: 'どちらでも', include: '含む', exclude: '除く' },
